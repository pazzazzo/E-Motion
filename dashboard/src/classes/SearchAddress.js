...
class SearchAddress {
    ...
    async autocompleteAddress(query) {
        ...
        return new Promise(async (resolve) => {
            let url = `https://api.mapbox.com/search/geocode/v6/forward?q=${encodeURIComponent(query)}&access_token=${mediaLoader.database.data["mapbox-token"]}&autocomplete=true&country=FR&limit=5&types=address`;
